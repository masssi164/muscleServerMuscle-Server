import { MuscleStruct } from "../controler/DbHandler"

export function muscles():MuscleStruct[] {
  let returningMuscles:MuscleStruct[] =  [
    {
...
export function createPlantarFlexors(): MuscleStruct[] {
  const muscles: MuscleStruct[] = [
    {
...
export function createHipFlexors(): MuscleStruct[] {
  const muscles: MuscleStruct[] = [
    {
...
export function createDorsalExtensorsAnkle(): MuscleStruct[] {
  const muscles: MuscleStruct[] = [
    {
...
export function createHipExtensors(): MuscleStruct[] {
  const muscles: MuscleStruct[] = [
    {
...
export function createKneeExtensors(): MuscleStruct[] {
  const muscles: MuscleStruct[] = [
    {
...
export function createHipAdductors(): MuscleStruct[] {
  const muscles: MuscleStruct[] = [
    {
